...
class HSDSchedulerEnvReplayBuffer(EnvReplayBuffer):
    def __init__(
            self,
            max_replay_buffer_size,
            env,
        ...
        self.skill_dim = skill_dim
        self.goal_dim = goal_dim
        self._skill = np.zeros((max_replay_buffer_size, skill_horizon, skill_dim))
    ...
    def add_sample(self, observation, action, reward, terminal,
                   skill, next_observation, cur_state, next_state, **kwargs):
